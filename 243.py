...
class System():
    ...
    def Update(self, time):
        ...
        for particle in self.particles:
            if particle.age > random.randint(5,15):
...
class Particle():
    ...
    def Update(self):
        ...
        #Gravity stuff
        grav = frame.Normal
        #self.gravity = frame.ZAxis
        #self.gravity.Reverse()
        tempVec = rg.Vector3d(self.vel)
        tempVec += grav
        
        t1 = rg.Point3d.Add(self.pos, grav)
        grav.Reverse()
        t2 = rg.Point3d.Add(self.pos, grav)
        line = rg.LineCurve(t1, t2)
        ...
        futureFrame = face.FrameAt(u, v)[1]
        
        projPt = futureFrame.ClosestPoint(futurePos)
        
        #Get future dir
        sc.doc.Objects.AddPoint(closestPt, self.system.attr)
        sc.doc.Objects.AddPoint(projPt)
