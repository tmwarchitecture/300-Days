...
######
class Box():
    def __init__(self, system, loc, type = 0):
        self.system = system
        ...
        if loc == 0:
            self.pos = rg.Point3d(25,25,95)
        elif loc == 1:
            self.pos = rg.Point3d(25,75,95)
        elif loc == 2:
            self.pos = rg.Point3d(75,75,95)
        elif loc == 3:
            self.pos = rg.Point3d(75,25,95)
        ...
        if type == 0:
            ...
            self.pos = rg.Point3d(50,50,0)
            self.vel = rg.Vector3d(0,0,0)
            self.acc = rg.Vector3d(0,0,0)
            xSize = rg.Interval(-200, 200)
            ySize = rg.Interval(-200, 200)
            zSize = rg.Interval(-50,0)
        self.prevPos = self.pos
        self.futureVel = None
        self.vel += self.acc
    ...
    def UpdatePosition(self):
        ...
        totalMovement = self.pos - self.prevPos
        self.prevPos = self.pos
        xform = rg.Transform.Translation(totalMovement)
...
class BoxSystem():
    ...
    def Update(self, time):
        ...
        if self.time %1==0:
            self.boxes.append(Box(self, 0))
            self.boxes.append(Box(self, 1))
            self.boxes.append(Box(self, 2))
            self.boxes.append(Box(self, 3))
