...
class System():
    def __init__(self):
        ...
        numClays = 1
        self.clays.append(Clay(self, color.GradientOfColors(grad, 0), rg.Interval(0, 30)))
...
class Ball():
    def __init__(self, system):
        self.system = system
        self.type = type
        self.pos = rg.Point3d(random.uniform(5,95), random.uniform(5,95), 90)
        self.size = 7
    ...
    def Update(self):
        ...
        self.acc = rg.Vector3d(0,0,0)
        vec = self.pos - rg.Point3d(50,50,50)
        #print vec.Length
        ...
        #target = 10
        #if (d - target) < 0:
        #    f = util.Remap((d-target), 0, -target, 0, -self.speed*.7)
        #else:
        #    f = util.Remap((d-target), 0, target, 0, self.speed*.7)
...
class Clay():
    def __init__(self, system, color, interval):
        ...
        self.geo = rg.Box(rg.Plane.WorldXY, rg.Interval(0,100),rg.Interval(0,100),interval)
