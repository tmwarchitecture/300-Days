...
class HUD():
    def __init__(self, skNum, numFrames):
        ...
        self.param1ID = r'2f4ba4b5-f1a2-46bd-afd0-c43e8c1f9612'
...
class meshObj4():
    def __init__(self):
        ...
        pt = rg.Point3d(46,46,50)
        plane = rg.Plane(pt, rg.Vector3d(0,0,1))
        xint = rg.Interval(0,8)
        yint = rg.Interval(0,8)
        xcount = 1
        ycount = 1
        self.mesh = rg.Mesh()
...
def main():
    ...
    for i in range(numFrames):
        ...
        ################################
        #HUD
        display.UpdateParam1('links: ' + str(len(mObj.vertices)))
