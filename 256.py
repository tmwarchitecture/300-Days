...
class Mesh():
    def __init__(self):
        offset = 20
        pt0 = rg.Point3d(offset, offset, 80)
        pt1 = rg.Point3d(100-offset, offset, 80)
        pt2 = rg.Point3d(100-offset, 100-offset, 80)
        pt3 = rg.Point3d(offset, 100-offset, 80)
        ...
        for i, v in enumerate(self.mesh.Vertices):
            self.mesh.VertexColors.Add(color.GetRandomNamedColor())
