...
class Link():
    ...
    def Resolve(self):
        ...
        boolX, xd0, xd1 = self.OverlappingIntervals(x0,x1, x0b, x1b)
        boolY, yd0, yd1 = self.OverlappingIntervals(y0,y1, y0b, y1b)
        boolZ, zd0, zd1 = self.OverlappingIntervals(z0,z1, z0b, z1b)
