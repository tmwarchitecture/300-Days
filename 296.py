...
class HUD():
    def __init__(self, skNum, numFrames):
        ...
        self.param1ID = r'83969259-a380-43a7-99c2-a051c53cf74a'
...
class vObject():
    ...
    def UpdatePosition(self):
        ...
        #d = (rg.Point3d(self.system.mesh.Vertices[self.index]) - self.pos).Length
        #print d
...
class meshObj4():
    def __init__(self):
        ...
        pt = rg.Point3d(35,35,10)
        plane = rg.Plane(pt, rg.Vector3d(0,0,1))
        xint = rg.Interval(0,30)
        yint = rg.Interval(0,30)
        xcount = 1
        ycount = 1
        self.mesh = rg.Mesh()
        self.mesh = self.mesh.CreateFromPlane(plane, xint, yint, xcount, ycount)
    ...
    def Update(self, time):
        ...
        count = 0
        for v in self.vertices:
            for growthPt in self.seed.growthPts:
                d = (v.pos - growthPt).Length
                if d < 20:
                    count += 1
                    v.Grow(d)
        print len(self.seed.growthPts)
        print count
