...
class Particle():
    ...
    def UpdateDisplay(self):
        ...
        if len(self.history) > 3:
            breps = rg.Brep.CreateFromLoft(self.history, rg.Point3d.Unset, rg.Point3d.Unset, rg.LoftType.Normal,False)
            if len(breps) > 0:
                self.pipe = breps[0]
    ...
    def CreateRectangles(self):
        ...
        self.plane.Rotate(math.radians(20), self.plane.Normal)
