...
class Ball():
    def __init__(self):
        self.attr = rc.DocObjects.ObjectAttributes()
        self.attr.ColorSource = rc.DocObjects.ObjectColorSource.ColorFromObject
        self.attr.ObjectColor = color.GetRandomNamedColor()
        
        self.pos =  rg.Point3d(50,50,50)
        self.sphere = rg.Sphere(self.pos, 10)
    ...
    def Update(self):
        ...
        sc.doc.Objects.Delete(self.sphereID, True)
        self.sphereID = sc.doc.Objects.AddSphere(self.sphere)
