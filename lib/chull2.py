#  chull.py  a pure Python convex hull calculation in 3D
#
...
#This was found at https://github.com/varkenvarken/blenderaddons/blob/master/chull.py
...
class Hull:
	def __init__(self,pts):
		"""3D Convex Hull
		input:
		    pts [list]: rg.Point3d or rg.Point3f
		returns:
		    hull object, with faces, edges, and vertices
		"""
		v = []
		for eachPt in pts:
			v.append(Vector(eachPt.X, eachPt.Y, eachPt.Z))
		self.vertices = []
		self.edges = []
		self.faces = []
		self.ReadVertices(v)
