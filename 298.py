...
class vObject():
    def __init__(self, system, v, i):
        ...
        param = self.system.crvOrig.ClosestPoint(self.pos)
        cp = self.system.crvOrig.PointAt(param[1])
        d = (cp-self.pos).Length
        self.d = d
        if d < sc.doc.ModelAbsoluteTolerance:
            self.isAnchor = True
        else:
            self.isAnchor = False
    ...
    def UpdatePosition(self):
        ...
        #self.vel *= util.Constrain(self.vel.Length, 0, .5)
...
class meshObj4():
    def __init__(self):
        ...
        self.tm = rc.Render.TextureMapping.CreatePlaneMapping(plane, rg.Interval(0,100), rg.Interval(0,100), rg.Interval(0,0))
        ...
        mat.SetBitmapTexture(fd.FileName)
        mat.CommitChanges()
        self.attr.MaterialIndex = index        
        
        #self.attr.SetBitmapTexture(fd.FileName)
        ...
        self.meshOrig = rs.coercemesh(r'a4e05c9b-245f-41ca-af04-719eb99e5e01')
        self.crvOrig = rs.coercecurve(r'3fe5bee9-3119-4ceb-b136-2cfc21573104')
        self.mesh = self.meshOrig.Duplicate()
        self.id = None
        
        xform = rg.Transform()
        self.mesh.SetTextureCoordinates(self.tm, xform, False)
