...
class Particle():
    ...
    def ProjectVectorToPlane(self, vec, plane):
    ...
    def Update(self):
        ...
        #######################################################
        frame = self.GetClosestFrame(self.pos)
        self.pos = frame.Origin
        #rs.AddCircle(frame, 2)
        ...
        self.vel = self.ProjectVectorToPlane(self.vel, frame)
        self.vel += grav
