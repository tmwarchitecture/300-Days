...
class meshObj4():
    def __init__(self):
        ...
        ids = [r'8391d06b-0053-44da-91a6-795826b8885d',r'a9cf9d65-79b3-47b0-ab9a-7d05d2594627',r'65ceb9ff-6a7c-4b96-97b2-d86748779ae6',r'baa2e748-2662-4e51-aae4-848f6249b62d',r'acd2d95d-cf87-4412-bee9-1981ce3e9b14']
        self.crvs = []
        meshes = []
        for id in ids:
            self.crvs.append(rs.coercecurve(id))
            m = rg.Mesh.CreateFromCurvePipe(self.crvs[-1], 4, 6, 1, rg.MeshPipeCapStyle.Dome, True, [self.crvs[-1].Domain])
            meshes.append(m)
        self.mesh = rg.Mesh.CreateBooleanUnion(meshes)[0]
        self.mesh.Faces.ConvertQuadsToTriangles()
        
        self.mesh = rs.coercemesh(r'c32f077f-395b-482b-b428-590fc5d0d2d2')
