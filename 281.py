...
class meshObj():
    def __init__(self):
        ...
        ####Triangulate####
        oldFaces = []
        for faceIndex, face in enumerate(self.mesh.Faces):
            ...
            self.mesh.Faces.AddFace(i2, i3, i0)
            oldFaces.append(faceIndex)
        
        self.mesh.Faces.DeleteFaces(oldFaces)
        self.mesh.Compact()
        #print
    ...
    def Update(self, t):
        ...
        if False:
            for i, face in enumerate(self.mesh.Faces):
                if self.FaceArea(face) > 50:
                    self.TriangulateAndSubdivide(i)
    ...
    def TriangulateAndSubdivide(self, faceIndex):
        i0 = self.mesh.Faces[faceIndex].A
        i1 = self.mesh.Faces[faceIndex].B
        i2 = self.mesh.Faces[faceIndex].C
