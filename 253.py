...
class Mesh():
    def __init__(self):
        offset = 10
        pt0 = rg.Point3d(offset, offset, 90)
        pt1 = rg.Point3d(100-offset, offset, 90)
        pt2 = rg.Point3d(100-offset, 100-offset, 90)
        pt3 = rg.Point3d(offset, 100-offset, 90)
