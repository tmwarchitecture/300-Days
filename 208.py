...
class System():
    def __init__(self):
        ...
        for i in range(10):
            self.particles.append(Particle(self, 0))
...
class Particle():
    ...
    def AssignNeighbors(self):
        if self.index == 0:
            self.neigh0 = self.system.particles[4]
            self.neigh1 = self.system.particles[1]
            self.neigh2 = self.system.particles[1]
            self.neigh3 = self.system.particles[2]
        if self.index == 1:
            self.neigh0 = self.system.particles[5]
            self.neigh1 = self.system.particles[2]
        if self.index == 2:
            self.neigh0 = self.system.particles[6]
            self.neigh1 = self.system.particles[3]
            self.neigh2 = self.system.particles[3]
            self.neigh3 = self.system.particles[0]
        if self.index == 3:
            self.neigh0 = self.system.particles[7]
            self.neigh1 = self.system.particles[0]
        if self.index == 4:
            self.neigh0 = self.system.particles[5]
            self.neigh1 = self.system.particles[1]
            self.neigh2 = self.system.particles[5]
            self.neigh3 = self.system.particles[6]
        if self.index == 5:
            self.neigh0 = self.system.particles[6]
            self.neigh1 = self.system.particles[2]
        if self.index == 6:
            self.neigh0 = self.system.particles[7]
            self.neigh1 = self.system.particles[3]
            self.neigh2 = self.system.particles[4]
            self.neigh3 = self.system.particles[7]
        if self.index == 7:
            self.neigh0 = self.system.particles[4]
            self.neigh1 = self.system.particles[0]
    ...
    def Update(self, time):
        self.val = math.cos(time*.05)
        xform = rg.Transform.Rotation(math.radians(self.val*2), rg.Point3d(50,50,0))
