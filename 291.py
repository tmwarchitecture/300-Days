...
class meshObj3():
    def __init__(self):
        ...
        self.target = geo.Particle(rg.Point3d(20,20,20), geo.RandomVector3d(5))
    ...
    def Subdivide(self):
        ...
        while hasOneChanged:
            ...
            for i, face in enumerate(self.mesh.Faces):
                ...
                d = (self.mesh.Faces.GetFaceCenter(i) - self.target.pos).Length
                maxDist = util.Remap(d, 20, 800, 2, 70)
